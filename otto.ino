...
void walk(int steps, int T){
  ...
  int O[4] = {
    0, 0, 0, 0  };
  double phase_diff[4] = {
    DEG2RAD(0), DEG2RAD(0), DEG2RAD(-90), DEG2RAD(-90)  };
...
void moonWalkRight(int steps, int T){
  ...
  int O[4] = {
    -15 ,15, 0, 0  };
  double phase_diff[4] = {
    DEG2RAD(0), DEG2RAD(180 + 120), DEG2RAD(90), DEG2RAD(90)  }; 
...
void upDown(int steps, int T){
  ...
  int O[4] = {
    -15, 15, 0, 0  };
  double phase_diff[4] = {
    DEG2RAD(180), DEG2RAD(0), DEG2RAD(270), DEG2RAD(270)  };
...
void flapping(int steps, int T){
  ...
  int O[4] = {
    -A[0], A[1], 0, 0  };
  double phase_diff[4] = {
    DEG2RAD(0), DEG2RAD(180), DEG2RAD(90), DEG2RAD(-90)  };
